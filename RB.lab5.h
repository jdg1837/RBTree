...
link preorder_in(char* input, int* i);	//preorder traversal while deserializing. recursive

char* preorder_out(link node, char* output, int* count);	//preorder traversal while serializing. recursive
